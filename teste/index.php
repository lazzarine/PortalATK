...
<section class="container-fluid ">
 <!---Espaço do Carrousel-->
	<div class="linha-vertical col-lg-8">
		...
		<!--http://portal.atacadao.com.br/img/Informe%2046%20final.pdf
			<!-- Esquerda Direita -->
			<div class="row">
...
<!--- COMENTARIO LADO CARROUSEL-->
	<div class="margin-top-50 col-lg-4">
		...
		<!--<div class="media">
			...
			<div class="media-body">
				<h4 class="media-heading " style="color:orangered"><b style="color:red">Xô</b>,Perdas</h4>
				<p class="desc"></p> <a target="_blank" href="operação_prato_limpo.php">Clique aqui e veja</a>
             </div>
		</div>-->
		<div class="media">
			<div class="media-left">
				<img src="images/rv.jpg" class="media-object" style="height:103px; width:91px;">
			</div>
			<div class="media-body">
				<h4 class="media-heading " style="color:orangered">Revista Informe</h4>
                <p class="desc">Fique por dentro das novidades e aproveite também para saber mais sobre nossa Empresa</p>
				<a href="http://portal.atacadao.com.br/img/Informe%2046%20final.pdf" target="_blank" style="color:green;">Confira!</a>
		</div>
