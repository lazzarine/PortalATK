...
class Database {
    ...
    private $db_user = "filial35";  // Change as required
    private $db_pass = "senhafilial";  // Change as required
    private $db_name = "atacadao"; // Change as required
    ...
    public function selectDst($table, $rows = '*', $join = null, $where = null, $order = null, $limit = null) {
        // Create query from the variables passed to the function
        $q = 'SELECT DISTINCT ' . $rows . ' FROM ' . $table;
        if ($join != null) {
            $q .= ' JOIN ' . $join;
        }
        if ($where != null) {
