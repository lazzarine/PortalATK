                        ...
                        <tbody>
                            ...
                            foreach ($read->getResult() as $resultado):
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="painel.php?exe=sacola/operadoredit&id=<?php echo $idoperador; ?>" class="fa fa-user btn btn-info"> Editar</a></td>
...
window.location.href="painel.php?exe=sacola/operadores&delete="+id;
}
</script>
<?php
$read->disconnect();
